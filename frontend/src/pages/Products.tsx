...
/** Catalog: names, cost, and sell prices per customer segment. Stock is read-only. */
export default function Products() {
  ...
  const openEdit = (p: Product) => {
    ...
    setForm({
      ...
      wholesale_price: Number(p.wholesale_price ?? p.sell_price),
      restaurant_price: Number(p.restaurant_price ?? p.sell_price),
  ...
  return (
    <AppLayout
      title="Sản phẩm"
      description={`${tab === "active" ? activeCount : archivedCount} sản phẩm · giá theo tệp khách. Nhập hàng ở Kho.`}
      actions={
    ...
    >
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right">Sỉ</TableHead>
                <TableHead className="text-right">Quán</TableHead>
                <TableHead className="text-right">Lẻ</TableHead>
                ...
                filtered.map((p) => {
                  ...
                  return (
                    <TableRow key={p.id}>
                      ...
                      <TableCell className="text-right text-sm">{formatVND(p.wholesale_price)}</TableCell>
                      <TableCell className="text-right text-sm">{formatVND(p.restaurant_price)}</TableCell>
      ...
      <DestructiveConfirmDialog
        ...
        description={
          deleteTarget
            ? `Mặt hàng "${deleteTarget.name}" sẽ bị gỡ khỏi catalog. Thao tác này không hoàn tác.`
            : ""
        }
        ...
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="grid gap-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {editing ? (
                <div className="grid gap-1.5">
                  ...
                  <p className="text-xs text-muted-foreground">Tăng tồn bằng phiếu nhập trên trang Kho hàng.</p>
                </div>
              ) : (
                <div className="grid gap-1.5">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="grid gap-1.5">
                <Label>Giá quán (₫)</Label>
                <Input
                  type="number"
                  min={0}
                  value={form.restaurant_price}
                  onChange={(e) => setForm({ ...form, restaurant_price: Number(e.target.value) })}
                />
              </div>
              <div className="grid gap-1.5">
                <Label>Giá lẻ (₫)</Label>

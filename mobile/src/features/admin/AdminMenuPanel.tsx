...
const MODULES: Array<{ href: Href; title: string; desc: string; icon: keyof typeof Ionicons.glyphMap }> = [
  ...
  { href: "/(admin)/module/products" as Href, title: "Sản phẩm", desc: "Giá sỉ / quán / lẻ", icon: "pricetags-outline" },
  { href: "/(admin)/module/inventory" as Href, title: "Kho hàng", desc: "Sổ phiếu nhập", icon: "layers-outline" },
